...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Daily Goals', 'Sit back and relax'];
    progressListArray = ['Work on the Course', 'Listen to Music'];
    completeListArray = ['Breakfast', 'Getting Stuff Done'];
    onHoldListArray = ['Procrastination'];
  }
}
...
function updateDOM() {
  ...
  // Backlog Column
  backlogList.textContent = ''; // reset and remove all elements within the list
...
function allowDrop(e) {
  e.preventDefault(); // allows to drop an element into another element
}
